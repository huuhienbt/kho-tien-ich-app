...
- Không tự gửi Prompt ra ngoài; nội dung nằm trong bộ nhớ tạm để người dùng chọn `Dán`. Việc tự dán chỉ thực hiện được khi ứng dụng đích hỗ trợ chính thức.
- Xóa khung quảng bá `Tiện ích mới – Lịch Việt & xem ngày theo tuổi` khỏi banner Trang chủ và chuyển banner sang bố cục một cột cân đối.
